...
import NotAchieved from "./../assets/Notachieved.png"
...
const SafetyAccidentCard: React.FC = () => {
  ...
  // Simple logic untuk achieved/not achieved berdasarkan total actual vs total target
  const totalActual = actualData.reduce((a, b) => a + b, 0);
  const totalTarget = targetData.reduce((a, b) => a + b, 0);
  const isAchieved = totalActual <= totalTarget;
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-2 h-full flex flex-col w-full">
      <div className="flex items-center justify-between mb-1">
        <h2 className="text-sm font-bold text-gray-800">0KM Claim</h2>
