...
const SafetyPatrolList: React.FC = () => {
  ...
  // Handle modal
  const openModal = (safetyPatrol: SafetyPatrolData) => {
    setSelectedSafetyPatrol(safetyPatrol);
    setIsModalOpen(true);
  };
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm">
                    {selectedSafetyPatrol.accident_date}
                  </p>
                </div>
                <div>
                  <span className="text-xs font-semibold text-gray-500 block">
                  ...
                  <p className="text-sm">
                    {selectedSafetyPatrol.component_code}
                  </p>
                </div>
                <div>
                  <span className="text-xs font-semibold text-gray-500 block">
                  ...
                  <p className="text-sm">{selectedSafetyPatrol.plant_code}</p>
                </div>
                <div>
                  <span className="text-xs font-semibold text-gray-500 block">
                    BU
                  </span>
                  <p className="text-sm">{selectedSafetyPatrol.bu}</p>
                </div>
                <div>
                  <span className="text-xs font-semibold text-gray-500 block">
                    Accident Name
                  ...
                  <p className="text-sm">
                    {selectedSafetyPatrol.accident_name}
                  </p>
                </div>
                <div>
                  <span className="text-xs font-semibold text-gray-500 block">
                  ...
                  <p className="text-sm">{selectedSafetyPatrol.place}</p>
                </div>
                <div>
                  <span className="text-xs font-semibold text-gray-500 block">
                    Category
                  ...
                  <p className="text-sm">
                    <span
                      className={`px-2 py-1 rounded text-xs font-semibold ${getAccidentCategoryClass(
                        selectedSafetyPatrol.accident_category
                      )}`}
                    >
                      {selectedSafetyPatrol.accident_category}
                    </span>
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {selectedSafetyPatrol.injured_person}
                  </p>
                </div>
                <div>
                  <span className="text-xs font-semibold text-gray-500 block">
                  ...
                  <p className="text-sm">{selectedSafetyPatrol.damage}</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm bg-gray-50 p-3 rounded">
                    {selectedSafetyPatrol.circumstance}
                  </p>
                </div>
                <div>
                  <span className="text-xs font-semibold text-gray-500 block">
                  ...
                  <p className="text-sm bg-gray-50 p-3 rounded">
                    {selectedSafetyPatrol.fact_finding}
                  </p>
                </div>
                <div>
                  <span className="text-xs font-semibold text-gray-500 block">
                  ...
                  <p className="text-sm bg-gray-50 p-3 rounded">
                    {selectedSafetyPatrol.temporary_action}
                  </p>
                </div>
                <div>
                  <span className="text-xs font-semibold text-gray-500 block">
                  ...
                  <p className="text-sm bg-gray-50 p-3 rounded">
                    {selectedSafetyPatrol.permanent_action}
                  </p>
                </div>
              </div>
            </div>
