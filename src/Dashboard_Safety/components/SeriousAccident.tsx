...
const SeriousAccident: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-2 h-full flex flex-col justify-between">
      {/* Title */}
      <h2 className="text-sm font-bold text-center mb-1">Accident</h2>
      ...
      <div className="flex items-center justify-center gap-2 pt-1">
        ...
        <div className="flex flex-col items-center gap-0.5">
          <button className="flex item-center gap-1 border border-red-500 text-red-500 px-2 py-0.5 rounded hover:bg-red-50 transition-colors">
